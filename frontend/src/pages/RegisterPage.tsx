...
const RegisterPage = () => {
  ...
  const ValidationItem: React.FC<{ isPassed: boolean; text: string }> = ({ isPassed, text }) => (
    ...
    >
      ...
      <Row className="w-100 m-0">
        <Col
          md={6}
          lg={7}
          className="d-none d-md-flex flex-column justify-content-center align-items-start position-relative p-5"
          style={{
        ...
        >
          ...
          <div className="d-flex flex-column justify-content-center" style={{ zIndex: 2, paddingLeft: "60px" }}>
            <h1 className="text-white fw-bold mb-3" style={{ fontSize: "3rem" }}>
              Selamat Datang!
            </h1>
            <h5 className="text-white opacity-75 fw-light mb-5">Kelola Dana Jadi Lebih Sip bersama SipDana</h5>
          </div>
        </Col>
        ...
        <Col md={6} lg={5} className="d-flex flex-column justify-content-center align-items-center p-4 bg-white position-relative">
              ...
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <Form.Group className="mb-3">
                  ...
                  <InputGroup>
                    ...
                    <Form.Control type="text" name="username" placeholder="Masukkan nama..." value={formData.username} onChange={handleChange} style={{ ...inputStyle, borderLeft: 0, borderRadius: "0 10px 10px 0" }} required />
                  </InputGroup>
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <InputGroup>
                    ...
                    <Form.Control type="email" name="email" placeholder="Masukkan email..." value={formData.email} onChange={handleChange} style={{ ...inputStyle, borderLeft: 0, borderRadius: "0 10px 10px 0" }} required />
                  </InputGroup>
                </Form.Group>
                ...
                <Form.Group className="mb-2">
                  ...
                  <InputGroup>
                    ...
                    <Form.Control
                      ...
                      required
                    />
                    <InputGroup.Text className="bg-white border-start-0 text-muted" style={{ cursor: "pointer", borderRadius: "0 10px 10px 0" }} onClick={() => setShowPassword(!showPassword)}>
          ...
          <div className="text-center text-muted small mt-4">© 2025 SipDana. All Rights Reserved.</div>
        </Col>
      </Row>
    </div>
  );
