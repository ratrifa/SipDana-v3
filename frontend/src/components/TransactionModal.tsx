...
import { CheckCircle, XCircle, Calendar, Tag, FileText, Wallet2, ArrowUpCircle, ArrowDownCircle } from "react-bootstrap-icons";
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div className="row g-3">
              <div className="col-6">
                <Form.Group>
                  <Form.Label className="fw-semibold small text-muted mb-2">
                    <Calendar size={14} className="me-1" /> Tanggal
                  </Form.Label>
              ...
              <div className="col-6">
                <Form.Group>
                  <Form.Label className="fw-semibold small text-muted mb-2">
                    <Tag size={14} className="me-1" /> Kategori
                  </Form.Label>
            ...
            <Form.Group className="mt-3 mb-3">
              <Form.Label className="fw-semibold small text-muted mb-2">
                <Wallet2 size={14} className="me-1" /> Nominal (Rp)
              </Form.Label>
            ...
            <Form.Group className="mb-4">
              <Form.Label className="fw-semibold small text-muted mb-2">
                <FileText size={14} className="me-1" /> Keterangan
              </Form.Label>
